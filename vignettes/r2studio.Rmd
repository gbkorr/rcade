...
This article describes the `R2Studio` ROM, which lets you run RStudio... in RStudio. Unlike `vignette("snake")`, this article is not meant to be a detailed walkthrough and instead just provides an overview of how this ROM works. You can always inspect the ROM object (`View(R2Studio)`) to take a closer look at its code.
