...
[the rom] 
a downside is that a game like this deserves its own documentation (since it uses complex systems), which I don't have reason enough to make...
...
actually kinda frustrated with how the game turned out-- it could be way more fluid and good-looking, but it's not worth redoing everything


#turning around?

#vertical scrolling where?
a staircase is a great demo for this
...
<details>
  <summary>**CodeTODOTDO**</summary>
screenscroll vertical or whatever but you need a better name for it
</details>
...
## (use the collision data to spawn enemies)
## (maybe rename leveldata, yeah I like that!)
