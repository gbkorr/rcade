...
This article goes through the full process of making and testing the `Snake` ROM. Snake is a good game to demonstrate the basic input and gamelogic functionality of the package, and it doesn't require fancy graphics; graphical capabilities are explored in `vignette("rrio")`.
