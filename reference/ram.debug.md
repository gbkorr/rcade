...
|                |     |                                                                                                                                                                                                                                                |
| `time.inputs`  |     | For each frame, time it took to run [`inputs.get()`](https://gbkorr.github.io/rcade/reference/inputs.get.md) and [`inputs.process()`](https://gbkorr.github.io/rcade/reference/inputs.process.md).                                             |
|                |     |                                                                                                                                                                                                                                                |
