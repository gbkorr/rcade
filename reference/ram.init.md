...
|-----------------|-----|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                 |     |                                                                                                                                                                                                                                   |
| `$ROM`          | ` ` | [ROM](https://gbkorr.github.io/rcade/reference/rom.init.md) object the game is run with.                                                                                                                                          |
|                 |     |                                                                                                                                                                                                                                   |
| `$ticks`        |     | Number of ticks the game has processed.                                                                                                                                                                                           |
|                 |     |                                                                                                                                                                                                                                   |
| `$time`         |     | [Time](https://gbkorr.github.io/rcade/reference/time.sec.md) of the latest frame reached by the RAM.                                                                                                                              |
|                 |     |                                                                                                                                                                                                                                   |
| `$rng`          |     | Local RNG state for the RAM; see [ram.set_rng](https://gbkorr.github.io/rcade/reference/ram.set_rng.md)                                                                                                                           |
|                 |     |                                                                                                                                                                                                                                   |
